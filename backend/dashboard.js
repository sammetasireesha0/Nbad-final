...
async function getCurrentUserLoginID() {
    try {
        const response = await fetch('http://104.131.2.178:3000/api/currentUserLoginID');
...
function getRecordDetails() {
  var userID = currentUserLoginID
      ...
      fetch(`http://104.131.2.178:3000/api/getRecordDetails?userID=${userID}&forWhat=${forWhat}`)
...
function saveRecord() {
      ...
      // Replace 'http://localhost:3000' with your actual server URL
      fetch('http://104.131.2.178:3000/api/saveRecord', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
function deleteRecord() {
      ...
      // Replace 'http://104.131.2.178:3000' with your actual server URL
      fetch(`http://104.131.2.178:3000/api/deleteRecord?userID=${userID}&forWhat=${forWhat}`, {
        method: 'DELETE',
      })
      .then(response => response.json())
      .then(data => {
