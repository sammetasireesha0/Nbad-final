...
describe('signup', () => {
  ...
  it('should handle successful registration', async () => {
    fetchMock.postOnce('http://104.131.2.178:3000//signupUser', {
      success: true
    });
...
describe('addToUserSessions', () => {
  ...
  it('should handle successful addToUserSessions', async () => {
    fetchMock.postOnce('http://104.131.2.178:3000/addToUserSessions', {
      success: true
    });
...
describe('submitLogin', () => {
  ...
  it('should handle successful login', async () => {
    fetchMock.postOnce('http://104.131.2.178:3000/loginuser', {
      success: true,
      UserID: 'mockedUserID'
    });
